...
contract NashEscrow  {
    ...
    uint private nashFee = 40000000000000000;
     ...
     */
    address internal nashTreasuryAddress = 0xfF096016A3B65cdDa688a8f7237Ac94f3EFBa245;
    ...
    mapping(uint => NashTransaction) private escrowedPayments;
    ...
    constructor(address _cUSDTokenAddress, uint256 _agentFee,
     uint256 _nashFee, address _nashTreasuryAddress) {
     ...
     */
    function getNashFee() public view returns(uint) {
        return nashFee;
    }
   ...
   function initializeDepositTransaction(uint256 _amount, string calldata _phoneNumber) public {
    ...
    /**
      ...
      */
    function getTransactionByIndex(uint _transactionID) public view returns (NashTransaction memory) {
    ...
    /**
      ...
      * @return the transaction in questsion.
      */
    function getNextUnpairedTransaction(uint _transactionID) public view returns (NashTransaction memory) {
